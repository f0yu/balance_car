...
//  sConfigOC.OCPreload = TIM_OCPreload_Disable
...
void HAL_TIM_OC_DelayElapsedCallback(TIM_HandleTypeDef *htim)
{
    if(htim -> Instance == TIM3)
    {
        ...
        if(htim ->  Channel == HAL_TIM_ACTIVE_CHANNEL_1)
        {
            ...
            __HAL_TIM_SET_COMPARE(&htim3,TIM_CHANNEL_1,Capture1 + Final_Moto1);
//            pulse_count++;  
        }
        ...
        if(htim ->  Channel == HAL_TIM_ACTIVE_CHANNEL_2)
        {
            ...
            __HAL_TIM_SET_COMPARE(&htim3,TIM_CHANNEL_2,Capture2 + Final_Moto2);
//            pulse_count++;  
        }
